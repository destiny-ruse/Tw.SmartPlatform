---
name: tw-directory-structure-documenter
...
```powershell
python .agents/skills/tw-directory-structure-documenter/scripts/generate_directory_structure_doc.py
```

指定根目录和输出文件：

```powershell
python .agents/skills/tw-directory-structure-documenter/scripts/generate_directory_structure_doc.py --root backend/dotnet --output docs/architecture/dotnet-directory-structure.md
```
