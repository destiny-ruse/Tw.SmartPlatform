...
/// <summary>
/// 覆盖服务ExposureResolver的核心行为和边界条件
/// </summary>
public class ServiceExposureResolverTests
{
    ...
    /// <summary>
    /// 验证ResolveExplicitExposeServicesHonorsIncludeSelf
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// 验证ResolveKeyedExposureCarries键
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// 验证ResolveOpenGenericExposesGenericInterface定义
    /// </summary>
    [Fact]
