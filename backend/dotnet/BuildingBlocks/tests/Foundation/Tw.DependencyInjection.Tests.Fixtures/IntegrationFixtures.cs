...
/// <summary>
/// 订单服务默认实现，按命名匹配暴露 <see cref="IOrderService"/>
/// </summary>
...
/// <summary>
/// 微信支付提供方，按 key "wechat" 注册为 keyed service
/// </summary>
...
/// <summary>
/// 结算服务，通过 [FromKeyedServices] 注入指定 key 的支付提供方
/// </summary>
