...
/// <summary>
/// Provides HMAC-SHA384 hash computation and verification helpers.
/// </summary>
public static class HmacSha384Hasher
{
    /// <summary>Computes the HMAC-SHA384 hash for a string.</summary>
    ...
    /// <returns>The HMAC-SHA384 hash as a hexadecimal string.</returns>
    ...
    /// <summary>Computes the HMAC-SHA384 hash for bytes.</summary>
    ...
    /// <summary>Computes the HMAC-SHA384 hash for a file.</summary>
    /// <param name="key">The HMAC key.</param>
    ...
    /// <summary>Computes the HMAC-SHA384 hash for a stream without disposing it.</summary>
    /// <param name="key">The HMAC key.</param>
    ...
    /// <summary>Verifies an HMAC-SHA384 hash for a string using fixed-time byte comparison.</summary>
    /// <param name="key">The HMAC key.</param>
    ...
    /// <summary>Verifies an HMAC-SHA384 hash for bytes using fixed-time byte comparison.</summary>
    /// <param name="key">The HMAC key bytes.</param>
    ...
    {
        return HmacComputation.VerifyHash(key, bytes, hash, HMACSHA384.HashData);
    }
}
