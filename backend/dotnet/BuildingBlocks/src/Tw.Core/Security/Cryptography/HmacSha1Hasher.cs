...
/// <summary>
/// Provides HMAC-SHA1 hash computation and verification helpers.
/// </summary>
public static class HmacSha1Hasher
{
    /// <summary>Computes the HMAC-SHA1 hash for a string.</summary>
    ...
    /// <returns>The HMAC-SHA1 hash as a hexadecimal string.</returns>
    ...
    /// <summary>Computes the HMAC-SHA1 hash for bytes.</summary>
    ...
    /// <summary>Computes the HMAC-SHA1 hash for a file.</summary>
    /// <param name="key">The HMAC key.</param>
    ...
    /// <summary>Computes the HMAC-SHA1 hash for a stream without disposing it.</summary>
    /// <param name="key">The HMAC key.</param>
    ...
    /// <summary>Verifies an HMAC-SHA1 hash for a string using fixed-time byte comparison.</summary>
    /// <param name="key">The HMAC key.</param>
    ...
    /// <summary>Verifies an HMAC-SHA1 hash for bytes using fixed-time byte comparison.</summary>
    /// <param name="key">The HMAC key bytes.</param>
