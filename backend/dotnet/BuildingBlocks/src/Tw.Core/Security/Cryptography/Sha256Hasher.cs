...
/// <summary>
/// Provides SHA-256 hash computation and verification helpers.
/// </summary>
public static class Sha256Hasher
{
    ...
    /// <summary>Computes the SHA-256 hash for bytes.</summary>
    ...
    /// <summary>Computes the SHA-256 hash for a file.</summary>
    ...
    /// <summary>Computes the SHA-256 hash for a stream without disposing it.</summary>
    ...
    /// <summary>Verifies a SHA-256 hash for a string using fixed-time byte comparison.</summary>
    ...
    /// <summary>Verifies a SHA-256 hash for bytes using fixed-time byte comparison.</summary>
