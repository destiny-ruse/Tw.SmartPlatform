...
public static class StringCryptographyExtensions
{
    ...
    /// <summary>
    /// 使用 TripleDES 加密字符串并返回 Base64 密文
    /// </summary>
