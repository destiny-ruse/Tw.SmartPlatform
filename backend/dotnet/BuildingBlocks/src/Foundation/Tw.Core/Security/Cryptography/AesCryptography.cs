...
/// <summary>
/// 封装SymmetricCryptographyCore相关的数据和行为
/// </summary>
internal static class SymmetricCryptographyCore
{
    ...
    /// <summary>
    /// 说明EncryptString在当前类型中的职责
    /// </summary>
    /// <param name="input">用于提供nput</param>
    /// <param name="key">用于定位目标数据或缓存项的键</param>
    /// <param name="iv">用于提供v</param>
    /// <param name="mode">用于提供mode</param>
    /// <param name="padding">用于提供padding</param>
    /// <param name="isKeyBase64">用于提供s键Base64</param>
    /// <param name="encoding">用于提供encoding</param>
    /// <param name="profile">用于提供profile</param>
    ...
    /// </summary>
    /// <param name="iv">用于提供v</param>
    /// <param name="cipherBytes">用于提供cipherBytes</param>
    /// <returns>方法完成后返回给调用方的结果对象</returns>
    ...
    /// </summary>
    /// <param name="bytes">用于提供bytes</param>
    /// <param name="ivLength">用于提供vLength</param>
    /// <returns>方法完成后返回给调用方的结果对象</returns>
