...
public static class Sha3512Hasher
{
    ...
    /// <returns>十六进制字符串形式的 SHA3-512 哈希</returns>
    ...
    /// <summary>计算字节的 SHA3-512 哈希</summary>
    ...
    /// <summary>计算文件的 SHA3-512 哈希</summary>
    ...
    /// <summary>计算流的 SHA3-512 哈希且不释放该流</summary>
    ...
    /// <summary>使用固定时间字节比较验证字符串的 SHA3-512 哈希</summary>
    ...
    /// <summary>使用固定时间字节比较验证字节的 SHA3-512 哈希</summary>
