...
{
    /// <summary>
    /// 返回字符串是否为 <see langword="null"/> 或空字符串
    /// </summary>
    public static bool IsNullOrEmpty(this string? str) => string.IsNullOrEmpty(str);

    /// <summary>
    /// 返回字符串是否为 <see langword="null"/>、空字符串或空白字符串
    /// </summary>
    public static bool IsNullOrWhiteSpace(this string? str) => string.IsNullOrWhiteSpace(str);

    /// <summary>
    /// 使用基础字符大小写规则将字符串的第一个 UTF-16 字符转换为大写
    /// </summary>
    ...
    /// <summary>
    /// 使用基础字符大小写规则将字符串的第一个 UTF-16 字符转换为小写
    /// </summary>
    ...
    /// <summary>
    /// 使用基础 UTF-16 字符大小写规则将字符串转换为 snake_case
    /// </summary>
    ...
    /// <summary>
    /// 使用 <see cref="string.Format(string, object?[])"/> 格式化字符串
    /// </summary>
    ...
    /// <summary>
    /// 说明Change第一个CharacterCase在当前类型中的职责
    /// </summary>
    /// <param name="source">用于提供source</param>
    /// <param name="converter">用于提供转换器</param>
    ...
    /// <summary>
    /// 说明AppendSeparator在当前类型中的职责
    /// </summary>
    /// <param name="builder">承载服务注册或主机配置的构建器</param>
    /// <param name="previousWasSeparator">用于提供previousWasSeparator</param>
