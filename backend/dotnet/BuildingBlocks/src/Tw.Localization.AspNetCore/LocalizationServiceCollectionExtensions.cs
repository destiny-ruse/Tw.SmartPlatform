...
/// 串联核心本地化能力（<c>Tw.Localization</c>）、Web 集成能力（<c>Tw.AspNetCore</c>）
/// 以及 <see cref="IStringLocalizer"/> 适配器，完成完整的 Web 本地化服务注册。
/// </summary>
/// <remarks>
...
public static class LocalizationServiceCollectionExtensions
{
    ...
    ///   <item><description>Web 集成服务（<see cref="IHttpContextAccessor"/>、取消令牌 Provider 等）</description></item>
